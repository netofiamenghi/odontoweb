...
<body class="nav-md">
    ...
    <div class="right_col" role="main">
        ...
        <h3 class="h3">Lista de Funcionários</h3>
            ...
            <tbody>
                ...
                while ($dados = mysqli_fetch_array($resultado)) :
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a href='alterar-funcionario.php?id=<?= $id ?>'><span class="glyphicon glyphicon-search"></span></a></td>
                    </tr>
                <?php
                endwhile;
                ?>
        ...
        <a class="btn btn-success" href="cadastrar-funcionario.php"><i class="fa fa-plus"></i> Novo</a>
