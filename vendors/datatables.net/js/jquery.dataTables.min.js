...
*/
(function(h) {
    "function" === typeof define && define.amd ? define(["jquery"], function(D) { return h(D, window, document) }) : "object" === typeof exports ? module.exports = function(D, I) {
        D || (D = window);
    ...
    function Da(a) {
        var b = m.defaults.oLanguage,
            c = a.sZeroRecords;
        !a.sEmptyTable && (c && "No data available na table" === b.sEmptyTable) && E(a, a, "sZeroRecords", "sEmptyTable");
    ...
    function ma(a, b) {
        ...
        return b.map(function(b, e) { c = Ia(a, e); return N(a, c.data, e, c.cells) })
    }
    ...
    function ka(a) {
        ...
        if (a.scrollBarVis !== v && a.scrollBarVis !== k) a.scrollBarVis = v, Y(a);
            ...
            }, w), J(function(a, b) { a.style.width = A[b] }, P), h(w).height(0));
            J(function(a, b) {
    ...
    function db(a) {
        h.each({ num: function(b) { return za(b, a) }, "num-fmt": function(b) { return za(b, a, Xa) }, "html-num": function(b) { return za(b, a, Aa) }, "html-num-fmt": function(b) { return za(b, a, Aa, Xa) } }, function(b, c) {
        ...
        pageButton: {
            _: function(a, b, c, d, e, f) {
                var g = a.oClasses,
                    ...
                    r;
                try { r = h(b).find(I.activeElement).data("dt-idx") } catch (o) {}
                p(h(b).empty(), d);
