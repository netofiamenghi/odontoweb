...
$html = "<html>
            ...
            <span style='font-size: 16px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Relatório de Produtos</span>
...
elseif ($status == 'I') :
    $where = "where pro_status = 'I' ";
else :
    $where = '';
endif;

if ($ordem == 'codigo') :
    $order = "order by pro_id";
else :
    $order = "order by pro_descricao";
endif;

$sql2 = "select * from produto $where $order";

$resultado2 = mysqli_query($conexao, $sql2);
while ($dados2 = mysqli_fetch_array($resultado2)) :
    $status = $dados2['pro_status'] == 'A' ? 'ATIVO' : 'INATIVO';
    $html .= "<tr>
                 <td class='text-center'> {$dados2['pro_id']} </td>
                 <td> {$dados2['pro_descricao']} </td>
                 <td> {$dados2['pro_unidade']} </td>
                 <td> $status </td>
            </tr>";
endwhile;
