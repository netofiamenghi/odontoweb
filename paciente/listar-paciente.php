...
<body class="nav-md">
    ...
    <div class="right_col" role="main">
        ...
        <h3 class="h3">Lista de Pacientes</h3>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center"><a href='alterar-paciente.php?id=<?= $id ?>'><span class="glyphicon glyphicon-search"></span></a></td>
                    </tr>
                <?php
                endwhile;
                ?>
        ...
        <a class="btn btn-success" href="cadastrar-paciente.php"><i class="fa fa-plus"></i> Novo</a>
    </div>
    <br />
    </div>
    <!-- /page content -->
